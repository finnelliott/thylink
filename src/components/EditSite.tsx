...
import ConnectDomainButton from "./ConnectDomainButton"
...
export default function EditSite({ 
    ...
    return (
        <div className="space-y-4 sm:max-w-lg mx-auto flex flex-col items-center justify-center relative">
            ...
            <div className="div flex w-full justify-center space-x-2 pb-4"><EditUserButton user={user} /><VisitSiteButton user={user} /><ConnectDomainButton user={user} /></div>
